...
set_to_evaluate = pd.read_csv('./Tim_22/Podaci/test_modified_encoded.csv')
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(in_features=329, out_features=512)
...
for epoch in range(epochs):
    ...
    print(
        f"Epoch [{epoch + 1}/{epochs}], Ones(% of 1): {percentageOfOnes:.4f}, Train Loss: {avg_train_loss:.4f}, Train Accuracy: {avg_train_acc:.2f}%, Test Loss: {avg_test_loss:.4f}, Test Accuracy: {avg_test_acc:.2f}%")
